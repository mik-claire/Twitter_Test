...
{
    public class var_dump
    {
        public string GetCleanJson(string json)
        {
            dynamic parsedJson = JsonConvert.DeserializeObject(json);
            string cleanJson = JsonConvert.SerializeObject(parsedJson, Formatting.Indented);
            return cleanJson.TrimStart('[').TrimEnd(']').Trim();
        }

        public string dump(object obj, int recursion)
        {
